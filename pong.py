...
def draw(c):
    ...
    if (ball_pos[0] <= (PAD_WIDTH + BALL_RADIUS)):
        if ((ball_pos[1] >= paddle1_pos[0]) and
        ...
        if ((ball_pos[1] >= paddle2_pos[0]) and
    ...
    # draw paddles
    c.draw_polygon([(0, paddle1_pos[0]),
                    (PAD_WIDTH, paddle1_pos[0]),
                    (PAD_WIDTH, paddle1_pos[1]),
                    (0, paddle1_pos[1])], 1, 'White', 'White')
    c.draw_polygon([((WIDTH - PAD_WIDTH), paddle2_pos[0]),
                    (WIDTH, paddle2_pos[0]),
                    (WIDTH, paddle2_pos[1]),
                    ((WIDTH - PAD_WIDTH), paddle2_pos[1])], 1, 'White', 'White')
    
    # draw scores
    c.draw_text(str(score1), ((WIDTH/2) - 50, 50), 25, 'White')
    c.draw_text(str(score2), ((WIDTH/2) + 50, 50), 25, 'White')
